    ...
    return (
        <View className='bg-white h-full'>
            <View className='justify-center items-center my-10'>
                <Text className='text-primary-2 font-bold text-3xl' style={{ textAlign: 'center', marginTop: 60 }}>Pembayaran</Text>
            </View>
            <View className="px-5">
                <Text className='text-secondary-2 text-3xl font-bold mx-2'>Total Harga</Text>
                <Text className='text-black text-xl font-bold m-2'>Rp 1,000,000</Text>
            </View>
