        ...
        <ScrollView className='bg-white' contentContainerStyle={{ paddingBottom: 200 }}>
            <View className="bg-white flex-1 h-full">
                ...
                <View className='justify-center items-center'>
                    <DashboardCard label={"Confirmed"} icon="supervised-user-circle" status={totalConfirmed} invitees={totalGuests} pax={`${((totalConfirmed / totalGuests) * 100).toFixed(2)} %`} color={"#3EC04B"} />
