    ...
    return (
        <View className='bg-white h-full'>
            <View className='justify-center items-center'>
                ...
                <Text className='text-black font-semibold text-lg mx-5 mb-10' style={{ textAlign: 'center' }}>Terima kasih sudah mengisi. Semoga lain kali kamu bisa ikut acaranya yaa!</Text>
